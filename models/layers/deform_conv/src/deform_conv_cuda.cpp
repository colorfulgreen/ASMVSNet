...
void modulated_deform_conv_cuda_forward(
  ...
  for (int b = 0; b < batch; b++) {
    ...
    // std::cout << "[0]columns: " << columns.size(0) << ", " << columns.size(1) << ", "  << columns.sum() << std::endl;
    ...
    for (int g = 0; g < group; g++) {
      // std::cout << "[1]columns: " << columns[g].size(0) << ", " << columns[g].size(1) << ", "  << columns[g].sum() << std::endl;
      // std::cout << "[1]weight: " << weight[g].flatten(1).sum() << std::endl;
      // std::cout << "[1]output: " << output[b][g].flatten(1).sum() << std::endl;
      output[b][g] = output[b][g]
                         .flatten(1)
                         .addmm_(weight[g].flatten(1), columns[g])
                         .view_as(output[b][g]);
      // std::cout << "[2]output: " << output[b][g] << std::endl;
    }
